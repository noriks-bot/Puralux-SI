...
<body <?php body_class( 'puralux-body' ); ?>>

<?php wp_body_open(); ?>

<div id="page" class="puralux-site">
  ...
  <header class="cal-header" role="banner">
    <div class="cal-header-inner">
      ...
      <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="cal-logo" aria-label="Puralux">
        <span class="cal-logo-text">PURALUX</span>
      </a>
